...
const (
	...
	// NodeAssistant is the entry point of a synthetic Flow generated by the
	// "Assistentes de IA" plugin (ADR 0027) — dispatches to the plugin's
	// runtime via ExecState.AssistantRuntime, never executed by a user-authored
	// graph directly.
