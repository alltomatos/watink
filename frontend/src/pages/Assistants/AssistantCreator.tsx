...
const AssistantCreator: React.FC = () => {
    ...
    // Modo persona (e pipeline.respondsAfterProactive)
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                if (a.mode === "persona") {
                    setPersona((cfg.persona as string) ?? "");
                ...
                <div className="max-w-3xl mx-auto flex flex-col gap-4">
                    <Card className="rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.06)]">
                        <CardContent className="p-5 flex flex-col gap-4">
                            ...
                            <div className="flex items-center justify-between rounded-xl border p-3">
                                <div>
                                    <p className="text-sm font-medium">Permitir múltiplos assistentes nesta conexão</p>
                    ...
                    <Card className="rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.06)]">
                        <CardContent className="p-5 flex flex-col gap-4">
                            ...
                            {(mode === "persona" || (mode === "pipeline" && respondsAfterProactive)) && (
                    ...
                    <Card className="rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.06)]">
                        <CardContent className="p-5 flex flex-col gap-4">
                            <Label>Gatilho</Label>
                            <Tabs value={triggerType} onValueChange={(v) => setTriggerType(v as "any" | "keyword")}>
                            ...
                            <button
                                type="button"
                                className="flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground w-fit"
